    ...
    return (
      <div className="min-h-screen bg-[#F7F4E9] flex items-center justify-center p-4">
        <div className="text-center bg-white rounded-3xl p-10 shadow-2xl border border-red-100 max-w-md w-full">
          ...
          <p className="text-foreground/70 mb-8 leading-relaxed">{error}</p>
          <Link
            href="/dashboard"
            className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-primary to-foreground text-white rounded-xl hover:from-foreground hover:to-primary transition-all duration-200 hover:shadow-xl font-medium"
          >
